    ...
    return (
        <div>
                        ...
                        {features.map((feature, index) => (
                            ...
                            >
                                <div className="absolute inset-0 flex items-center justify-center ml-[400px] mt-4">
                                    <FaCircleArrowRight
                                        className="w-10 h-10 text-black opacity-0 transition-opacity duration-300 group-hover:opacity-100"
                                    />
                                </div>
            ...
            <div className="flex justify-center items-center">
                <Button className="text-white px-4 py-2 rounded-md bg-gradient-to-r from-purple-500 to-indigo-600 hover:from-indigo-600 hover:to-purple-500 transition">
                    All Projects
                </Button>
            </div>
