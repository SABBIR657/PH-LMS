...
const blogs = [
  {
    ...
    image:
      "https://phero-web.nyc3.cdn.digitaloceanspaces.com/blog-images-prod/public/files/1686368859721.jpg",
    title: "প্রোগ্রামিং হিরো জব প্লেসমেন্ট রিপোর্ট কার্ড মে ২০২২ - মে ২০২৩",
    description:
      "এই রিপোর্ট কার্ডে আমরা দেখবো, মে ২০২২ থেকে মে ২০২৩ পর্যন্ত প্রোগ্রামিং হিরোর শিক্ষার্থীরা কেমন পারফর্ম করেছে এবং কীভাবে তারা চাকরির বাজারে নিজেদের জায়গা করে নিয়েছে।",
  },
  {
    id: 2,
    category: "Web Development",
    image:
      "https://phero-web.nyc3.cdn.digitaloceanspaces.com/blog-images-prod/public/files/1669992976522.jpg",
    title: "ওয়েব ডেভেলপমেন্ট-এর চাহিদা কেমন? আর এর চাহিদা কি কমে যাবে?",
    description:
      "ওয়েব ডেভেলপমেন্ট কি ভবিষ্যতে টিকে থাকবে? নাকি এর চাহিদা কমে যাবে? এই ব্লগে আমরা ওয়েব ডেভেলপমেন্ট ইন্ডাস্ট্রির বর্তমান অবস্থা এবং ভবিষ্যৎ সম্ভাবনা নিয়ে আলোচনা করেছি।",
  },
  {
    id: 3,
    category: "Web Development",
    ...
    description:
      "নতুনদের জন্য ওয়েব ডেভেলপমেন্ট শেখার সঠিক গাইডলাইন। কীভাবে শুরু করবেন, কোন স্কিল শেখা দরকার এবং কীভাবে চাকরির বাজারে প্রবেশ করবেন, তার বিস্তারিত দিকনির্দেশনা পাবেন এই ব্লগে।",
  },
];
  ...
  return (
    <CommonWrapper>
      <section className="bg-[#0B0D19] py-10 px-5 md:px-10 lg:px-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-[60%_40%] gap-x-4 relative">
