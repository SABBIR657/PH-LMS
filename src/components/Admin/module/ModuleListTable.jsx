...
export const columns = [
  { name: "NAME", uid: "moduleName" },
  { name: "Total Video", uid: "videoList" },
  ...
  return (
    <div className="ml-3 mr-3">
      <Table
        isCompact
        removeWrapper
        aria-label="Module table with searching, pagination and sorting"
        ...
        <TableBody
          emptyContent={
            <div className="flex justify-center items-center p-6">
              <span className="text-gray-500 text-lg">No modules found</span>
            </div>
          }
          items={modules}
          isLoading={isLoading}
